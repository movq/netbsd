/*	$NetBSD: nouveau_subdev_bios_init.c,v 1.1 2014/08/06 12:36:29 riastradh Exp $	*/

#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_subdev_bios_init.c,v 1.1 2014/08/06 12:36:29 riastradh Exp $");
