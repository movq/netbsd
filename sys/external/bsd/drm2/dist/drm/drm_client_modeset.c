/*	$NetBSD: drm_client_modeset.c,v 1.1 2021/12/18 20:11:00 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: drm_client_modeset.c,v 1.1 2021/12/18 20:11:00 riastradh Exp $");
